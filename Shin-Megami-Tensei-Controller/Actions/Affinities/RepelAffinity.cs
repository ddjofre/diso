...
public class RepelAffinity: BaseAffinity
{
    public override string nameAffinity => "Rp";
    ...
    {
        return $"{target.name} devuelve {actualUnitPlaying.damageRound} daño a {actualUnitPlaying.name}";
    }
}