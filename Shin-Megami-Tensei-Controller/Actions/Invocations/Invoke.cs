...
public class Invoke
{
    ...
    public void MakeInvoke(Player player, int indexMonsterToInvoke, int indexMonsterToReplace)
    {
        Team team = player.Team;
        Unit monsterToReplace = team.UnitsInGame[indexMonsterToReplace];
        Unit monsterToInvoke = team.UnitsInReserve[indexMonsterToInvoke]; // Usar índice real
        ...
        team.UnitsInReserve[indexMonsterToInvoke] = monsterToReplace; // Usar índice real
