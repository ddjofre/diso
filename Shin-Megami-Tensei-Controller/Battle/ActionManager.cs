...
public class ActionManager
{
    ...
    private SingleTargetAttack GetActionFromChoice(int actionChoice)
    {
        if (actionChoice == 1)
        {
        ...
        else if (actionChoice == 2)
        {
            ...
            return new SingleTargetAttack(_view, attackGun, _turnCalculator);
        }
    ...
    {
        SingleTargetAttack action = GetActionFromChoice(actionChoosed);
